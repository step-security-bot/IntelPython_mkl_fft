...
The `mkl_fft` package offers  interfaces that act as drop-in replacements for equivalent functions in NumPy and SciPy. Learn more about these interfaces [here](github.com/IntelPython/mkl_fft/blob/master/mkl_fft/interfaces/README.md).
